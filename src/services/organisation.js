import { getOrganisationAdditionalWelcome, getOrganisationDefaultServiceId, getOrganisationGreeting, getOrganisationLanguage, getOrganisationLogoBase64, getOrganisationMessage, getOrganisationName, getOrganisationSecretKey, getOrganisationServiceTimeout, getOrganisationTranslationLanguages, getOrganisationWaitingMessage } from '../repositories/organisation.js';
...
export const infoService = () => {
    try {
        ...
        const organisationLogoBase64 = getOrganisationLogoBase64();
        const organisationGreeting = getOrganisationGreeting();
        const organisationMessage = getOrganisationMessage();
        const organisationWaitingMessage = getOrganisationWaitingMessage();
        const organisationAdditionalWelcome = getOrganisationAdditionalWelcome();
        const organisationLang = getOrganisationLanguage();
        const defaultServiceId = getOrganisationDefaultServiceId();
        const translationLanguages = getOrganisationTranslationLanguages();
        return {
            success: true,
            statusCode: 200,
        ...
        return {
            success: false,
            statusCode: 400,
            message: `Error getting organisation info`,
            responseObject: null
        }
    }
}
